...
class Tunnel(FurnitureObject):
    name = 'tunnel'
    disabled_robot_collision_for_links = ["right_sideB", "left_sideB", "top_sideB"]
    ...
    def __init__(self, pose: np.array, lengths: List[float],
        ...
        :param collision_walls_thickness: thickness of the walls preventing the robot to put object around tunnel
    ...
    def urdf(pos: List[float], rpy: List[float], lengths: List[float], thickness: float, collision_thickness: float,
        ...
        """
        this function generates text for .urdf file with given parameters to create tunnel object
        ...
        :param collision_thickness: thickness of the walls preventing the robot to put object around tunnel
        :param disp_walls: True if the walls preventing objects to go around tunnel should be displayed
