...
class Shelf(FurnitureObject):
    ...
    def urdf(pos: List[float], rot: List[float], inside=True, material: str = 'brown',
        ...
        """
        this function generates text for .urdf file with given parameters to create shelf object

        :param pos: position of the shelf in [x, y, z]
        :param rot: rotation of the shelf in [r, p, y]
        :param inside: True if inside of shelf should be displayed, else most of the shelf will be box
    ...
    def srdf(inside_shelf=True):
        ...
        :param inside_shelf: True if inside of shelf should be displayed, else most of the shelf will be box
        ...
        if inside_shelf:
            return f"""
                ...
                <contact name="inside_shelf_surface">
                        <link name="top_desk"/>
                         <point>
                             0.175  0.60 -0.355   0.175   0.01 -0.355    -0.19   0.01 -0.355     -0.19  0.60 -0.355
                             0.175 -0.60 -0.355   0.175  -0.01 -0.355    -0.19  -0.01 -0.355     -0.19 -0.60 -0.355
                         </point>
